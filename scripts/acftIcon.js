...
const acft_to_icon = [
    ...
    //cessnas
    {icao: "CESSNA 172", icon: "cessna.svg", width: 6},
    {icao: "CESSNA 172 STUDENT", icon: "cessna.svg", width: 6},
    {icao: "CESSNA 402", icon: "cessna.svg", width: 6}, 

    //lotta CRJs
    {icao: "BOMBARDIER CRJ700", icon: "crjx.svg", width: 12},
